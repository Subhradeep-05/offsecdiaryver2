      ...
      >
        ...
        >
          ...
          <h2 style={{ color: "#f4a261" }}>
            OffSecDiary Certified Malware Exploit Fundamentals
          </h2>
          <p className="form-description">
            A 1-month, structured, mentor-led certification designed to introduce learners to the fundamentals of malware engineering and exploit development. Build a strong low-level foundation in how software behaves, how vulnerabilities arise, and how attackers leverage them.
          </p>
        </motion.div>
        ...
        >
          <form className="application-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <label>Payment (Cert. Investment: ₹2,000)</label>
              <div style={{ marginBottom: "1rem" }}>
                <img
                  src="/data/QR/OCMEF.png"
                  alt="OCMEF Payment QR Code"
