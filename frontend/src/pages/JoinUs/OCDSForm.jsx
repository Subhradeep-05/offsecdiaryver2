...
const OCDSForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = { ...form, formType: "CERTIFICATIONS", certificationName: "OCDS" };
      ...
      >
        ...
        >
          ...
          <h2 style={{ color: "#f4a261" }}>
            OffSecDiary Certified DevSecOps Specialist
          </h2>
          <p className="form-description">
            OCDS is a 4-month, structured, mentor-led certification program
            designed to build deep expertise in integrating security across
            modern DevOps workflows. Learn DevSecOps fundamentals, CI/CD
            pipeline security, containerization, Kubernetes, cloud security,
          ...
          <form className="application-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <div style={{ marginBottom: "1rem" }}>
                <img
                  src="/data/QR/OCDS.png"
                  alt="OCDS Payment QR Code"
