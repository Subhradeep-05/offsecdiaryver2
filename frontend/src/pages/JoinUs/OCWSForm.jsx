...
const OCWSForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = { ...form, formType: "CERTIFICATIONS", certificationName: "OCWS" };
      ...
      >
        ...
        >
          ...
          <h2 style={{ color: "#f4a261" }}>
            OffSecDiary Certified WebSecurity Specialist
          </h2>
          <p className="form-description">
            OCWS is a 3-month, structured, mentor-led certification program
            designed to build deep expertise in web application security,
            vulnerability assessment, and secure coding practices. Learn OWASP
            Top 10, manual testing methodologies, Burp Suite, API security,
            authentication flaws, and real-world exploitation techniques.
          </p>
        </motion.div>
        ...
        >
          <form className="application-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <label>Payment (Cert. Investment: ₹6,000)</label>
              <div style={{ marginBottom: "1rem" }}>
                <img
                  src="/data/QR/OCWS.png"
                  alt="OCWS Payment QR Code"
