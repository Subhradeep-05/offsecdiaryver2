...
const OCDPAForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = { ...form, formType: "CERTIFICATIONS", certificationName: "OCDPA" };
      ...
      >
        ...
        >
          ...
          <h2 style={{ color: "#f4a261" }}>
            OffSecDiary Certified Data Privacy Associate
          </h2>
          <p className="form-description">
            A 4-month, structured, mentor-led certification program designed to build deep expertise in data privacy principles, regulatory compliance, and privacy-focused risk management practices. Learn how personal data is collected, processed, stored, shared, and protected within modern organizations.
          </p>
        </motion.div>
        ...
        >
          <form className="application-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <label>Payment (Cert. Investment: ₹7,000)</label>
              <div style={{ marginBottom: "1rem" }}>
                <img
                  src="/data/QR/OCDPA.png"
                  alt="OCDPA Payment QR Code"
