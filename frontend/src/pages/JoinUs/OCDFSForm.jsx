      ...
      >
        ...
        >
          ...
          <h2 style={{ color: "#f4a261" }}>
            OffSecDiary Certified Digital Forensics Specialist
          </h2>
          <p className="form-description">
            OCDFS is a 3-month, structured, mentor-led certification program
            designed to build deep expertise in digital investigations, evidence
            handling, and forensic analysis. Learn disk forensics, memory
            analysis, log investigations, incident reconstruction, and
            professional reporting for real-world digital forensic
            investigations.
          </p>
        </motion.div>
          ...
          <form className="application-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <div style={{ marginBottom: "1rem" }}>
                <img
                  src="/data/QR/OCDFS.png"
                  alt="OCDFS Payment QR Code"
