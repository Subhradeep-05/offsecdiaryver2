...
const CARLAForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = { ...form, formType: "CERTIFICATIONS", certificationName: "CARLA" };
      ...
      >
        ...
        >
          ...
          <h2 style={{ color: "#f4a261" }}>
            Certified AI Red-Teaming & LLM-Security Analyst
          </h2>
          <p className="form-description">
            CARLA is a 2-month, structured, mentor-led certification program
            designed to build deep expertise in AI security testing, adversarial
            analysis, and Large Language Model (LLM) risk assessment. Learn
            prompt injection, jailbreak techniques, model misuse detection,
            secure AI design, and red-teaming methodology for AI-powered
            applications.
          </p>
        </motion.div>
          ...
          <form className="application-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <div style={{ marginBottom: "1rem" }}>
                <img
                  src="/data/QR/CARLA.png"
                  alt="CARLA Payment QR Code"
